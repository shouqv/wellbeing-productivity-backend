...
from .views import GoalsIndex , GoalDetail , TasksIndex ,TaskDetail , EmotionIndex , LinkGoalToTask , UnLinkGoalToTask, CheckTodayEmotionSubmission ,SignupUserView,VisionBoardDetial
...
path('visionboard/', VisionBoardDetial.as_view(), name='vision-board'),
