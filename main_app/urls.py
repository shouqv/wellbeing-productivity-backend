...
from .views import GoalsIndex , GoalDetail , TasksIndex ,TaskDetail , EmotionIndex , LinkGoalToTask , UnLinkGoalToTask, CheckTodayEmotionSubmission ,SignupUserView,VisionBoardDetial,DashBoardInfo
...
path('visionboard/', VisionBoardDetial.as_view(), name='visionboard'),
path('dashboard/', DashBoardInfo.as_view(), name='dashboard'),
